 ...
 */
public class OldIndexingService implements Lifecycle, IndexPopulationService
{
    // TODO pull out an interface instead of overriding all methods
    public static final OldIndexingService NO_INDEXING = new OldIndexingService( null, null, null )
    {
        @Override
