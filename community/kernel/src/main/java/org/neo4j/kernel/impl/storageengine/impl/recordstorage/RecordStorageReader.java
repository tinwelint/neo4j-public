...
public class RecordStorageReader extends DefaultCursors implements StorageReader, TxStateHolder
{
    ...
    @Override
    public RelationshipTraversalCursor allocateRelationshipTraversalCursorCommitted()
    {
        return new DefaultRelationshipTraversalCursor( allocateRelationshipGroupCursorCommitted(), null, false );
    }
