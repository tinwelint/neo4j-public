...
public final class StandardFormatSettings
{
    ...
    public static final int NODE_RECORD_MAXIMUM_ID_BITS = 35;
    public static final int RELATIONSHIP_MAXIMUM_ID_BITS = 35;
    public static final int PROPERTY_RECORD_MAXIMUM_ID_BITS = 36;
    public static final int DYNAMIC_RECORD_MAXIMUM_ID_BITS = 36;
